...
%   img1= imread('33.jpg');img1 = rgb2gray(img1);img1 = im2double(img1);img2= imread('result.jpg');img2 = rgb2gray(img2);img2 = im2double(img2);[mpcqi pcqi_map] = PCQI(img1, img2);
%img1= imread('contrast_changed.png'); img2= imread('ref.png');window = ones(8);L = 100;[mpcqi pcqi_map] = PCQI(img1, img2, window, L);
%========================================================================
