...
plots = 0;% or 1 to turn diagnostic plots on or off.



%% import image
im_orig = imread('33.jpg');
% figure
% imshow(im_orig)
...
satLevel = 0.01; %percentage of the image to saturate to black or white, tweakable param
q = [satLevel/2 1-satLevel/2];

imRGB_orig=im_orig*255;
...
imwrite(cbunshape(imRGB,size(im_orig))/255,outFile,'jpg');
figure
